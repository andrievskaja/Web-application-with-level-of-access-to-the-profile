...
<html class="no-js">
    <head>
        ...
        <title>Добавить приложение</title>
        ...
        <div class="layout-content">
            <div class="layout-container">
                <div class="page-header">
                    ...
                    <a href="#" id="saveAccount" class="btn btn-primary">Сохранить</a>
                </div>
                        ...
                        <div class="col-9">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" role="tabpanel" id="user-settings-general">
                                    ...
                                    <form:form action="${pageContext.servletContext.contextPath}/portal/adops/createApp" 
                                               method="post" 
