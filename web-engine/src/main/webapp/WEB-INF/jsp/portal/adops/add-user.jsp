                        ...
                        <div class="col-9">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" role="tabpanel" id="user-settings-general">
                                    ...
                                    <form:form action="${pageContext.servletContext.contextPath}/portal/adops/addUser" 
                                               method="post" 
...
<!--                                          <div class="form-group">
                                              <select class="form-control selectize narrow col-4" name="role" id="password">
